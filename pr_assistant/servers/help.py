class HelpMessage:
    ...
    def get_general_commands_text():
       commands_text = "> - **/review**: Request a review of your Pull Request.   \n" \
                ...
                ">See the [tools guide](https://pr-assistant.github.io/tools/) for more details.\n" \
    ...
    def get_review_usage_guide():
        output ="**Overview:**\n"
        output +=("The `review` tool scans the PR code changes, and generates a PR review which includes several types of feedbacks, such as possible PR issues, security threats and relevant test in the PR. More feedbacks can be [added](https://pr-assistant.github.io/tools/review/#general-configurations) by configuring the tool.\n\n"
                  "The tool can be triggered [automatically](https://pr-assistant.github.io/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) every time a new PR is opened, or can be invoked manually by commenting on any PR.\n")
        output +="""\
...
```
- With a [configuration file](https://pr-assistant.github.io/usage-guide/configuration_options/), use the following template:
```
[pr_reviewer]
some_config1=...
some_config2=...
```
    """
        ...
        output += f"\n\nSee the review [usage page](https://pr-assistant.github.io/tools/review/) for a comprehensive guide on using this tool.\n\n"
    ...
    def get_describe_usage_guide():
        ...
        output += "The tool can be triggered [automatically](https://pr-assistant.github.io/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) every time a new PR is opened, or can be invoked manually by commenting on a PR.\n"
        output += """\
...
"""
        ...
        output += """\
- When you first install the app, the [default mode](https://pr-assistant.github.io/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) for the describe tool is:
```
...
If you specify [custom labels](https://pr-assistant.github.io/tools/describe/#handle-custom-labels-from-the-repos-labels-page) in the repo's labels page or via configuration file, you can get tailored labels for your use cases.
...
'''
        ...
        output += f"\n\nSee the [describe usage](https://pr-assistant.github.io/tools/describe/) page for a comprehensive guide on using this tool.\n\n"
...
You can ask questions about the entire PR, about specific code lines, or about an image related to the PR code changes.     
        ...
        output += f"\n\nSee the [ask usage](https://pr-assistant.github.io/tools/ask/) page for a comprehensive guide on using this tool.\n\n"
...
"""
        ...
        output += f"\n\nSee the improve [usage page](https://pr-assistant.github.io/tools/improve/) for a comprehensive guide on using this tool.\n\n"
