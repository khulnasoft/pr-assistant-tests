...
```
3. Follow the instructions to build the Docker image, setup a secrets file and deploy on your own server from [here](https://pr-assistant.github.io/installation/github/#run-as-a-github-app) steps 4-7.
