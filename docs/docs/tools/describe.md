...
To run the `describe` automatically when a PR is opened, define in a [configuration file](https://pr-assistant.github.io/usage-guide/configuration_options/#wiki-configuration-file):
```
[github_app]
pr_commands = [
    "/describe",
...
![Describe markers after](https://khulnasoft.com/images/pr_assistant/describe_markers_after.png){width=512}
...
Custom labels can be defined in a [configuration file](https://pr-assistant.github.io/tools/custom_labels/#configuration-options), or directly in the repo's [labels page](#handle-custom-labels-from-the-repos-labels-page).
